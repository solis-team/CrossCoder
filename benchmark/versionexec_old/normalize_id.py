...
if __name__ == "__main__":
    ...
    benchmark_file = os.path.join(str(repo_root), 'benchmark', 'versionexec_old', 'versionexec_old.jsonl')
    
    generated_path = Path(args.generated_file)
    folder_name = generated_path.parent.name
    
    result_dir = os.path.join(str(repo_root), 'benchmark', 'versionexec_old', 'bcb_results')
